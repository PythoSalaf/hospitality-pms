...
/**
 * PageGoBack component for rendering a back button with a link.
 * @param url - The URL to navigate back to.
 * @param text - The text content of the back button. Default is "Back".
 */
const PageGoBack: React.FC<{ url: string; text?: string }> = ({
  url,
  text = "Back",
}) => {
  return (
    <div className="max-w-min">
      <Link href={url} className="max-w-min ">
        <div
